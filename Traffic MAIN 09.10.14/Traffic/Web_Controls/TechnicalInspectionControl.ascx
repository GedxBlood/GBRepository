<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TechnicalInspectionControl.ascx.cs"
    Inherits="Traffic.TechnicalInspectionControl" %>
...
<asp:Table ID="Table1" runat="server" HorizontalAlign="Left" BorderColor="#999999"
    ...
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_1" runat="server" Text="ID Транспорта"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            ...
            <asp:RequiredFieldValidator ID="vldr_1" runat="server" ErrorMessage="ID Транспорта: поле не заполнено"
    ...
    <asp:TableRow runat="server">
        ...
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_2" runat="server" Text="Дата прохождения ТО"></asp:Label>

        </asp:TableCell>

        <asp:TableCell runat="server">
            <asp:TextBox ID="txt_2" runat="server" Width="200px" MaxLength="50" TextMode="Date"></asp:TextBox>

        </asp:TableCell>

        <asp:TableCell runat="server" ForeColor="#CC0000">

            <asp:RequiredFieldValidator ID="vldr_2" runat="server" ErrorMessage="Дата прохождения ТО: поле не заполнено"
                Text="*" ControlToValidate="txt_2" Display="Static" Enabled="True"></asp:RequiredFieldValidator>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_3" runat="server" Text="Дата следующего ТО"
                Width="200px"></asp:Label>

        </asp:TableCell>

        <asp:TableCell runat="server">
            <asp:TextBox ID="txt_3" runat="server" Width="200px"   MaxLength="50" TextMode="Date"></asp:TextBox>

        </asp:TableCell>

        <asp:TableCell runat="server" ForeColor="#CC0000">
            <asp:RequiredFieldValidator ID="vldr_3" runat="server" ErrorMessage="Дата следующего ТО: поле не заполнено"
    ...
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_4" runat="server" Text="Стоимость"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            <asp:RequiredFieldValidator ID="vldr_4" runat="server" ErrorMessage="Стоимость: поле не заполнено"
    ...
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_5" runat="server" Text="Налог"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            <asp:RequiredFieldValidator ID="vldr_5" runat="server" ErrorMessage="Налог: поле не заполнено"
