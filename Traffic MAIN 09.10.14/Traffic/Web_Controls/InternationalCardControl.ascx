...
<asp:Table ID="Table1" runat="server" HorizontalAlign="Left" BorderColor="#999999"
    ...
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_1" runat="server" Text="Регистрационный ID"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            ...
            <asp:RequiredFieldValidator ID="vldr_1" runat="server" ErrorMessage="Регистрационный ID: поле не заполнено"
    ...
    <asp:TableRow runat="server">
        ...
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_2" runat="server" Text="Допуск"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            ...
            <asp:RequiredFieldValidator ID="vldr_2" runat="server" ErrorMessage="Допуск: поле не заполнено"
                Text="*" ControlToValidate="txt_2" Display="Static" Enabled="True"></asp:RequiredFieldValidator>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_3" runat="server" Text="Дата начала"
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            <asp:RequiredFieldValidator ID="vldr_3" runat="server" ErrorMessage="Дата начала: поле не заполнено"
    ...
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_5" runat="server" Text="ID Транспорта"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            <asp:RequiredFieldValidator ID="vldr_5" runat="server" ErrorMessage="ID Транспорта: поле не заполнено"
    ...
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">
            <asp:Label ID="lbl_6" runat="server" Text="ID Организации"></asp:Label>
        ...
        <asp:TableCell runat="server" ForeColor="#CC0000">
            <asp:RequiredFieldValidator ID="vldr_6" runat="server" ErrorMessage="ID Организации: поле не заполнено"
