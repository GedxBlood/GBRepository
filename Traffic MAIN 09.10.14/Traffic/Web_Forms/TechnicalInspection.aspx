<%@ Page Title="Технические Осмотры" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TechnicalInspection.aspx.cs" Inherits="Traffic.TechnicalInspection" %>
    ...
    <div id="container">
        <asp:MultiView ID="mv_Main" runat="server" ActiveViewIndex="0">
            <asp:View ID="view_DataGrid" runat="server">
                <asp:GridView ID="grv_TechnicalInspectionDataGrid" runat="server" AllowPaging="True"
